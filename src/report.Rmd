...
# Here we see the correlation between the 8 attributes and suprisengly there is no correlation at all between distance and all delays which was the opposite of what we expected 
