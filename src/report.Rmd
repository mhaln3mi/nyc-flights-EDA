...
# ggplot(head(plot4, 200), aes(x=origin, y=value, color=name)) +
...
flights %>%
  ...
  xlim(0,12.5)
```
<p id="caption">Figure 6: Departure delays per month</p>
...
flights %>%
  ...
  xlim(0,12.5)
```
<p id="caption">Figure 7: Arrival delays per month</p>
